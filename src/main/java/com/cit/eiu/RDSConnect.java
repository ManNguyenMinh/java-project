...
public class RDSConnect {
    ...
    private static final String SSL_CERTIFICATE = "ap-southeast-2-bundle.pem";
    ...
    private static X509Certificate createCertificate() throws Exception {
        ...
        URL url = RDSConnect.class.getClassLoader().getResource(SSL_CERTIFICATE);
        // URL url = IAMDatabaseAuthenticationTester.class.getClassLoader.getRe
        if (url == null) {
            throw new Exception();
        }
